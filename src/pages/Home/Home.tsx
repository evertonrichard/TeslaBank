  ...
  return (
    <div className="container-fluid p-0">
      ...
      <section className="container-fluid p-0 d-flex vh-100">
        ...
        <div className="container-fluid bg-tertiary w-50 d-flex align-items-center justify-content-center mobile padding-70px">
      ...
      <section className="container-fluid waves bg-info p-0 d-flex flex-column vh-100 padding-top-50px">
        <div className="container-sm padding-top-60px">
